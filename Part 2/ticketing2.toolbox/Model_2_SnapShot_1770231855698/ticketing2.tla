...
\* BEGIN TRANSLATION (chksum(pcal) = "f3b74af9" /\ chksum(tla) = "4138a350")
...
\* Process variable id of process HClient at line 158 col 9 changed to id_H
\* Process variable ip of process HClient at line 159 col 9 changed to ip_H
