...
(* --algorithm ticketing {
    variables
        ...
        MyTickets   = [m \in AllMalicious |-> {}] \* the tickets for the malicious clients
    ...
    define {
        ...
        IPs == Nat \union {-1} \* since now malicious exist
...
\* BEGIN TRANSLATION (chksum(pcal) = "bb17de55" /\ chksum(tla) = "4530d599")
\* Label s1 of process Server at line 94 col 13 changed to s1_
\* Label Done_ of process Server at line 141 col 9 changed to Done__
\* Process variable id of process Server at line 90 col 9 changed to id_
\* Process variable ip of process Server at line 91 col 9 changed to ip_
\* Process variable ip of process HClient at line 147 col 9 changed to ip_H
\* Process variable reply of process HClient at line 150 col 9 changed to reply_
